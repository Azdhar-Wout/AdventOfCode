...
for match in Lines:
    myMove = ord(match[2]) - 87
    ennemyMove = ord(match[0]) - 64    
    
    result1 = 0
    
    if(myMove == ennemyMove):
        result1 = 3
        
    elif(
            (myMove == 1 and ennemyMove == 3) or
            (myMove == 2 and ennemyMove == 1) or
            (myMove == 3 and ennemyMove == 2)
            ):
        result1 = 6
        
    score1 += myMove + result1
    
    if(myMove == 1):
       score2 += lose[ennemyMove - 1]
    elif(myMove == 3):
       score2 += win[ennemyMove - 1] + 6
    else:
       score2 += ennemyMove + 3
